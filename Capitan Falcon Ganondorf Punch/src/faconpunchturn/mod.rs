...
unsafe extern "C" fn captain_game_specialnturn(agent: &mut L2CAgentBase) {
...
unsafe extern "C" fn captain_effect_specialnturn(agent: &mut L2CAgentBase) {
...
pub fn install() {
	Agent::new("captain")
		.game_acmd("game_specialnturn", captain_game_specialnturn)
        .effect_acmd("effect_specialnturn", captain_effect_specialnturn)
		.install();
}
